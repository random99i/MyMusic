...
var gw=document.getElementById("g-w");
var gw1=document.getElementById("g-w1");
function change1(){
	var lis=document.getElementById("u-l").getElementsByTagName("li");
	lis[1].className="";
	lis[0].className="z-slt";
	gw1.style.display="none";
	gw.style.display="block";
}
function change2(){
	var lis=document.getElementById("u-l").getElementsByTagName("li");
	lis[0].className="";
	lis[1].className="z-slt";
	gw.style.display="none";
	gw1.style.display="block";
}
